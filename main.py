...
class Window(QMainWindow):
    def __init__(self):
        ...
        title = "Распознователь рукописных букв"
        top = 200
        left = 200
        width = 540
        height = 340
    ...
    def predicting(self):
        with tf.device('/gpu:0'):
            ...
            model = keras.models.load_model(r'C:\Users\DNS\Desktop\Creating the simplest neural network\model.h5')
            img = image.load_img('res.png', target_size=(278, 278))
